...
CREATE TABLE TB_MOVIMENTO_DOCUMENTO(
	...
	MOV_DOC_USUARIO_ID INTEGER NOT NULL,
	CONSTRAINT FOREIGN KEY (MOV_DOC_USUARIO_ID) REFERENCES TB_USUARIO(USU_ID),
...
INSERT INTO TB_MOVIMENTO_DOCUMENTO (MOV_DOC_ID,MOV_DOC_OBSERVACAO,MOV_DOC_DATA_MOVIMENTACAO,MOV_DOC_USUARIO_ID,MOV_DOC_DOCUMENTO_ID) VALUES (1,"O documento demorou ser entregue",'2018-2-3 16:18:30',1,1);
INSERT INTO TB_MOVIMENTO_DOCUMENTO (MOV_DOC_ID,MOV_DOC_OBSERVACAO,MOV_DOC_DATA_MOVIMENTACAO,MOV_DOC_USUARIO_ID,MOV_DOC_DOCUMENTO_ID) VALUES (2,"Entregue no mesmo dia",'2018-2-3 13:12:25',2,2);
